...
def sqnxt_23_1x_ibn_a_2(num_classes=10):
  model = SqueezeNext(1.0, [6, 6, 8, 1], num_classes)
  return model

def sqnxt_23_1x_v5_ibn_a_2(num_classes=10):
  model = SqueezeNext(1.0, [2, 4, 14, 1], num_classes)
  return model

def sqnxt_23_2x_ibn_a_2(num_classes=10):
  model = SqueezeNext(2.0, [6, 6, 8, 1], num_classes)
  return model


def sqnxt_23_2x_v5_ibn_a_2(num_classes=10):
